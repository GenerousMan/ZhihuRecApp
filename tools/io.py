...
if __name__ == "__main__":
    convert_answer_csv("zhihuRec/answer_infos.txt","source/answer_csv/", 10000)
    convert_user_csv("zhihuRec/user_infos.txt","source/user_csv/", 10000)
    convert_interaction_csv("zhihuRec/zhihu100M.txt","source/interaction_csv/", 10000)
    convert_question_csv("zhihuRec/question_infos.txt", "source/question_csv/", 10000)
